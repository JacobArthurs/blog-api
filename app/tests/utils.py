...
def create_mock_post(id, title, slug, content, tags=None, summary="Test summary", read_time_minutes=5, featured=False, view_count=0, comment_count=0, created_at=None, updated_at=None):
    mock_post = MagicMock()
    mock_post.id = id
    ...
    mock_post.comment_count = comment_count
...
def create_mock_comment(id, post_id, author_name, content, parent_id=None, replies=None, like_count=0, depth=0, created_at=None):
